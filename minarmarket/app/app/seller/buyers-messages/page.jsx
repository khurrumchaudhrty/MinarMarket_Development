        ...
        <div className="flex min-h-screen flex-col px-4">
            ...
            <div className="container flex-1 items-start md:grid md:grid-cols-[220px_1fr] md:gap-4 md:py-6">
                ...
                <main>
                    ...
                    {/* Pagination Controls */}
                    <div className="flex justify-end mt-6 gap-4 fixed bottom-4 right-4 bg-white p-3 rounded-lg shadow-md">
                        <button
                        ...
                        <button
                            ...
                            disabled={indexOfLastMessage >= messages.length || currentMessages.length < messagesPerPage}
                            className="px-4 py-2 bg-gray-300 rounded hover:bg-gray-400 disabled:opacity-50"
                        >
                            Next
                        </button>
