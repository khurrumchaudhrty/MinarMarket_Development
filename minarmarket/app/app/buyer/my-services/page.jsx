...
import { ServiceRequirementList } from "@/components/data-list"
import { useLocalStorage } from "@uidotdev/usehooks"
import Link from "next/link"
import { motion } from "framer-motion"
import { PlusCircle, Sparkles, Filter, ArrowDownUp, Search } from "lucide-react"
          ...
          <motion.div variants={itemVariants} className="flex flex-col gap-2">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                <h1 className="text-3xl font-bold text-gray-800">Service Requirements</h1>
              ...
              <Button
                ...
                asChild
              >
                <Link href="/app/buyer/list-service">
