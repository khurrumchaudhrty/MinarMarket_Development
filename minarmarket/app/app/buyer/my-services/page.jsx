                  ...
                  <div className="container flex-1 items-start md:grid md:grid-cols-[220px_1fr] md:gap-4 md:py-6">
                    ...
                    <main className="flex-1 px-6">
                        <div className="flex justify-between items-center mb-6">
                            <h1 className="text-2xl font-semibold">Service Requirements</h1>
                            <Link href="/app/buyer/list-service" className="bg-blue-600 text-white px-4 py-2 rounded-md hover:bg-blue-700">List Service</Link>
                        </div>
                        <ProductList />
                        </main>
                  </div>
