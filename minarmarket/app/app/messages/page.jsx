...
//         return uniqueMessages.sort((a, b) => new Date(a.timestamp || a.createdAt) - new Date(b.timestamp || b.createdAt))
//       })
//     } catch (error) {
...
//                 <Button variant="ghost" size="icon" className="h-8 w-8 rounded-full hover:bg-gray-100"><Plus className="h-5 w-5 text-gray-500" /></Button>
//                 <Button variant="ghost" size="icon" className="h-8 w-8 rounded-full hover:bg-gray-100"><MoreHorizontal className="h-5 w-5 text-gray-500" /></Button>
//               </div> */}
//             </div>
...
//                           <AvatarFallback className="text-white text-xs font-medium">{getInitials(selectedUser.name)}</AvatarFallback>
//                         </Avatar>
//                       )}
//                       <div className={`px-4 py-2 rounded-2xl max-w-xs shadow-sm ${
//                         msg.senderId === myId ? "bg-purple-500 text-white rounded-tr-none" : "bg-white rounded-tl-none"
//                       }`}>
...
//                   />
//                   <Button onClick={handleSendMessage} className="rounded-full bg-purple-500 hover:bg-purple-600 h-10 w-10 p-0 flex-shrink-0">
